...
public partial class AnnualTaxViewModel : ObservableObject
{
    ...
    public string FilingStatusDisplay
        => PaycheckCalc.Avalonia.Helpers.EnumDisplay.FederalFilingStatus(Session.FilingStatus.ToString());
    ...
    public async Task LoadScenariosAsync()
    {
        ...
        foreach (var s in all)
        {
            SavedScenarios.Add(new SavedAnnualScenarioItemViewModel
            {
                ...
                FilingStatusDisplay = PaycheckCalc.Avalonia.Helpers.EnumDisplay.FederalFilingStatus(
                    s.Profile.FilingStatus.ToString()),
                StateDisplay = PaycheckCalc.Avalonia.Helpers.EnumDisplay.UsStateName(
