...
public partial class SavedPaychecksViewModel : ObservableObject
{
    ...
    public async Task ExportCsvAsync(Guid id)
    {
        ...
        var dir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "PaycheckCalc", "exports");
    ...
    {
        await Task.CompletedTask; // PDF export not available in desktop version
    }
